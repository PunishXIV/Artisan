...
public unsafe partial struct AgentSatisfactionSupply
{
    ...
    public Span<ItemInfo> ItemSpan => new(Unsafe.AsPointer(ref Item[0]), 3);
    ...
    public Span<AgentDeliveryItemInfo> DeliveryInfoSpan => new(Unsafe.AsPointer(ref DeliveryInfo[0]), 3);
