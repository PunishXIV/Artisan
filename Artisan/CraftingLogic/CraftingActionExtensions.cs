...
namespace Artisan.CraftingLogic
{
    public static class CraftingActionExtensions
    {
        ...
        public static int QualityIncrease(this uint id)
        {
            ...
            double innovation = SolverLogic.GetStatus(Buffs.Innovation) is not null ? 0.5 : 0;
            double greatStrides = SolverLogic.GetStatus(Buffs.GreatStrides) is not null ? 1 : 0;
