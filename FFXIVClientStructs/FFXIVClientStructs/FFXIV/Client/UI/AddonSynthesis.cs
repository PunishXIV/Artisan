...
public unsafe struct AddonSynthesis
{
    ...
    [FieldOffset(0x2B0 + 0x08)] public AtkTextNode* HQLiteral; // "HQ" or "Collectability"
    [FieldOffset(0x2B8 + 0x08)] public AtkTextNode* HQPercentage; // "0" -> "100", also collectability
    [FieldOffset(0x2C0 + 0x08)] public AtkTextNode* StepNumber; // "5"
    
    [FieldOffset(0x2D8 + 0x08)] public AtkTextNode* CurrentProgress; // "100"
    [FieldOffset(0x2E0 + 0x08)] public AtkTextNode* MaxProgress; // "200"
    
    [FieldOffset(0x2F0 + 0x08)] public AtkTextNode* CurrentDurability; // "50"
    [FieldOffset(0x2F8 + 0x08)] public AtkTextNode* StartingDurability; // "80"
